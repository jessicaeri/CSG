...
//CLOSURES ----------------------
//a way to encapsulate and hide information. ENCLOSE
...
//   }
//   //innerFunction knows about outerVariable because it was created inside the same scope

//   return innerFunction;
// }

// const closureFunc = outerFunction();
// //This line calls outerFunction, which returns innerFunction. So now closureFunc is that inner function.
// //Even though outerFunction has finished running, the innerFunction it returned still remembers outerVariable.

// closureFunc(); // This runs innerFunction 
// //innerFunc -> prints outerVariable -> outer variable

// //OTHER EXAMPLES
// function outerFunction() {
//   let name = "Jess"; // variable created inside outerFunction

//   function innerFunction() {
//     console.log("Hello, " + name);
//   }

//   return innerFunction; // send the function out, but it keeps the 'name' in its backpack
// }
...
// 2. It creates a variable called name with the value "Jess".
// 3. It creates an innerFunction that uses name.
// 4. outerFunction ends — but the innerFunction is returned.
// 5. When you run greet(), the innerFunction still remembers name even though outerFunction already finished!
...
// .reduce - reduces the output to one value 
// (total, number) - the function used to pass .reduce 
// total - the running total 
// number - the current number (think like a loop)
// total + number - adding to the running total 
...
// SPREAD OPERATOR ----------
//(...array, x, y, z) SPREADS
// The spread operator is three dots ... that "spreads out" items inside something like an array or object — kind of like unpacking a box into its individual items.
//spreads everything into an array
...
// Spread	  ...array	Unpacks values (used when calling or combining)
// Rest	    ...args	  Packs values into an array (used in function parameters)
...
//   return nums.reduce((product, number) => product + number, 0);
// }

// console.log(multiplyAll(2, 4, 6)); //12

//SPREAD----------

// const arr1 = [1, 3, 5];
// const arr2 = [...arr1, 2, 4, 6];

// console.log(arr2);


// const obj1 = { a: "apples", b: "bananas" };

// const obj2 = { ...obj1, c: "cantalopes" };
